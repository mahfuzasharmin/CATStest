...
# Fig4B, 4D, 5A, S7 are plotted using this script. The data generation are part of Python notebooks: Fig4.ipynb and Fig5.ipynb

PROJECT_location = 'CATSevalData'
contextfile = glue("{PROJECT_location}/survival/HR_summary_context_panel.csv")
defile = glue("{PROJECT_location}/survival/HR_summary_de_panel.csv")
hpafile = glue("{PROJECT_location}/survival/HR_summary_hpa_panel.csv")
disfile = glue("{PROJECT_location}/survival/HR_summary_discarded_genes_panel.csv")
...
ggsave2(glue('{PROJECT_location}/Figures/Fig_5SB_survival.png'))
